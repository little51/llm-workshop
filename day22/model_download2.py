# usage     : python model_download2.py --repo_id repo_id
# example   : python model_download2.py --repo_id facebook/opt-350m
import argparse
import time
import requests
import json
...
def _download_model_from_mirror(_repo_id, _repo_type, _token, _e):
    ...
    i = 1
    for file in files:
        url = 'http://172.16.62.156/download' + file['path']
        if _e:
